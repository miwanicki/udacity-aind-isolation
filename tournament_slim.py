...
def main():
    ...
    test_agents = [
        Agent(AlphaBetaPlayer(score_fn=custom_score_4), "AB_Conflict"),
        Agent(AlphaBetaPlayer(score_fn=custom_score), "AB_Own-2*Opp"),
        Agent(AlphaBetaPlayer(score_fn=custom_score_2), "AB_Weighted"),
        Agent(AlphaBetaPlayer(score_fn=custom_score_3), "AB_Apart")
    ]
